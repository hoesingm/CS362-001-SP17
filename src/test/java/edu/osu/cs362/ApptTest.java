...
public class ApptTest {
	...
	// assertions
	 ...
	 @Test
	  ...
	  public void test12()  throws Throwable  {
		...
		// isValid() left side mutation test
	 @Test
	...
	// assertions
	 ...
	 // isValid() right side mutation test
	 @Test
	 ...
	 @Test
	  public void test15()  throws Throwable  {
		 ...
		 Appt appt = new Appt(startHour,
		         ...
		         description);
		// assertions
		 // test mutated startHour()
		 appt.setStartHour(25);
		 assertFalse(appt.getValid());
		 appt.setStartHour(22);
		 // test mutated startMinute()
		 appt.setStartMinute(77);
		 assertFalse(appt.getValid());
		 appt.setStartMinute(32);
		// test mutated startDay()
		 appt.setStartDay(77);
		 assertFalse(appt.getValid());
		 appt.setStartDay(25);
		 // test mutated startMonth()
		 appt.setStartMonth(77);
		 assertFalse(appt.getValid());
		 appt.setStartMonth(10);
		 
	 }

	  // toString(), return null coverage
	 @Test
	...
	// assertions
	  ...
	  public void test17()  throws Throwable  {
		 ...
		 assertEquals("\t11/30/2017 at 11:30am ,Birthday Party, This is my birthday party.\n", appt.toString());
		}
